dataset_folder = "Dataset/last" #"ml-1m"   "tourism_dataset"
preprocessed_dataset_folder = "Dataset/last" #"preprocessed_dataset" "preprocessed_tourism_dataset"
...
aggregation_strategies = ["BASE", "ADD", "GFAR"]  # ["BASE", "GFAR", "EPFuzzDA"] list of implemented aggregation strategies we want to test
